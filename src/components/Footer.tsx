      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-8">
            <div className="flex items-center">
              ...
              <h2 className="text-white text-2xl font-bold">WYLD</h2>
            </div>
            <p className="text-gray-400 mt-2">Revolutionizing banking with social currency.</p>
          ...
          <div>
            <h3 className="text-white text-lg font-medium mb-4">Card Options</h3>
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-400 hover:text-white">Standard Card</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Premium Card</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Influencer Card</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 Fintech Street, Mumbai, India 400001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@wyld.in</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} WYLD. All rights reserved.
          </p>
          <div className="mt-4 flex justify-center space-x-6">
            <a href="#" className="text-gray-400 hover:text-white text-sm">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-white text-sm">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-white text-sm">Card Agreement</a>
